  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        <div className="space-y-8 text-justify lg:w-1/2">
          <p>
            ...
            (ODS), donde los
            <span className="extra-info"> bosques urbanos</span> desempeñan un
            rol fundamental en la consecución de estos y específicamente
            contribuyen a lograr ciudades inclusivas, seguras, resilientes y
            sostenibles.
          </p>
          <p>
          ...
          <p>
            A partir de este relevamiento se generó una base de datos que
            facilita la elaboración de diagnósticos indispensables para
            planificar y gestionar el mejoramiento del arbolado de alineación de
            la ciudad de Tandil.
          </p>
        </div>
